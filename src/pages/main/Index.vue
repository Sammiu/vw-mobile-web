<template>
  <div>
    ...
    <div class="tab-bar__wrap">
      ...
      <div class="tab-bar_item" :class="{selected: viewName === 'project'}" @click.stop="viewName = 'project'">
        <svg class="icon" viewBox="0 0 1024 1024">
          <path
      ...
      <div class="tab-bar_item" :class="{selected: viewName === 'statistics'}" @click.stop="viewName = 'statistics'">
        <svg class="icon" viewBox="0 0 1024 1024">
          <path
      ...
      <div class="tab-bar_item" :class="{selected: viewName === 'aboutMe'}" @click.stop="viewName = 'aboutMe'">
        <svg class="icon" viewBox="0 0 1024 1024">
          <path
